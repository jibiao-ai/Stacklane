...
<p align="center">
  <img src="https://raw.githubusercontent.com/jibiao-ai/Stacklane/main/docs/logo.png?v=20260504" width="120" alt="Stacklane Logo" />
</p>
...
![登录](https://raw.githubusercontent.com/jibiao-ai/Stacklane/main/docs/screenshots/login.png?v=20260504)

### 平台概览 (Dashboard)

> 在线服务、GPU利用率、P95延迟、错误率等核心KPI；引擎分布饼图、资源趋势折线图、服务健康表

![Dashboard](https://raw.githubusercontent.com/jibiao-ai/Stacklane/main/docs/screenshots/dashboard.png?v=20260504)

### 即时对话 (Chat)

> 聊天框式对话界面，支持选择智能体、MCP 工具调用、流式输出、**随时中止**、快捷提示、Token 统计

![Chat](https://raw.githubusercontent.com/jibiao-ai/Stacklane/main/docs/screenshots/chat.png?v=20260504)

### 智能体管理

> 内置 AI 智能体市场，从开源社区一键拉取，支持 OpenAI / Anthropic / DeepSeek / Qwen / Ollama 多 Provider

![Agents](https://raw.githubusercontent.com/jibiao-ai/Stacklane/main/docs/screenshots/agents.png?v=20260504)

### 工作流编辑器 (Workflow)

> 类 Dify 拖拉拽式工作流编排，8 种节点类型，SVG 曲线连接，右侧配置面板（模型选择、重试机制、输出映射）

![Workflow](https://raw.githubusercontent.com/jibiao-ai/Stacklane/main/docs/screenshots/workflow.png?v=20260504)

### 技能商店

> 自动化技能库 - 定时器、PDF 转换、网页抓取、邮件发送等 12 个开源内置技能

![Skills](https://raw.githubusercontent.com/jibiao-ai/Stacklane/main/docs/screenshots/skills.png?v=20260504)

### GPU 管理

> 多集群 GPU 资源管理，节点/设备/资源池三合一

![GPU Management](https://raw.githubusercontent.com/jibiao-ai/Stacklane/main/docs/screenshots/gpu.png?v=20260504)

### 推理引擎

> 管理 vLLM、GPUStack、llama.cpp、TensorRT-LLM 推理运行时

![Runtimes](https://raw.githubusercontent.com/jibiao-ai/Stacklane/main/docs/screenshots/runtimes.png?v=20260504)

### 模型管理

> 模型全生命周期管理 - 导入、版本控制、部署、退役、兼容性矩阵

![Model Management](https://raw.githubusercontent.com/jibiao-ai/Stacklane/main/docs/screenshots/models.png?v=20260504)

### 服务管理

> 在线推理服务管理，引擎、延迟、吞吐量、副本数一目了然

![Services](https://raw.githubusercontent.com/jibiao-ai/Stacklane/main/docs/screenshots/services.png?v=20260504)

### 渠道管理

> 多平台消息渠道接入 - QQ、企业微信、飞书、微信、Telegram、Discord、Slack、DingTalk

![Channels](https://raw.githubusercontent.com/jibiao-ai/Stacklane/main/docs/screenshots/channels.png?v=20260504)

### Dify 集成

> LLM 应用平台集成 - 应用管理、工作流编排、执行监控、统计分析、费用追踪

![Dify](https://raw.githubusercontent.com/jibiao-ai/Stacklane/main/docs/screenshots/dify.png?v=20260504)

### 集成管理

> 管理外部系统集成：GPUStack GPU 编排、Prometheus 监控、Grafana 可视化

![Integrations](https://raw.githubusercontent.com/jibiao-ai/Stacklane/main/docs/screenshots/integrations.png?v=20260504)

### 流量治理

> 路由规则、A/B 测试、限流配置、熔断器

![Traffic](https://raw.githubusercontent.com/jibiao-ai/Stacklane/main/docs/screenshots/traffic.png?v=20260504)

### 租户管理

> 多租户隔离管理 - 配额分配、成员管理、资源隔离

![Tenants](https://raw.githubusercontent.com/jibiao-ai/Stacklane/main/docs/screenshots/tenants.png?v=20260504)

### 系统设置

> 平台全局配置、通知管理、审计日志、备份恢复、组件状态

![System](https://raw.githubusercontent.com/jibiao-ai/Stacklane/main/docs/screenshots/system.png?v=20260504)
